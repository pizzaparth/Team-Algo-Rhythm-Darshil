...
const FEATURES = [
  {
    ...
    accentColor: 'from-indigo-500/20 to-indigo-500/0 border-indigo-500/30'
  },
  {
    icon: Globe2,
    title: '🌐 Web Research',
    ...
    accentColor: 'from-blue-500/20 to-blue-500/0 border-blue-500/30'
  },
  {
    icon: GitGraph,
    ...
    accentColor: 'from-emerald-500/20 to-emerald-500/0 border-emerald-500/30'
  },
  {
    icon: Scale,
    ...
    accentColor: 'from-purple-500/20 to-purple-500/0 border-purple-500/30'
  },
  {
    icon: UserCheck,
    ...
    accentColor: 'from-amber-500/20 to-amber-500/0 border-amber-500/30'
  },
  {
    icon: History,
    ...
    accentColor: 'from-cyan-500/20 to-cyan-500/0 border-cyan-500/30'
  }
];
