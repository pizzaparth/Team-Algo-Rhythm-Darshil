import type { LandingDomainItem, LandingReasoningTree, LandingWorkflowStep } from './landingTypes';
...
export const SAMPLE_REASONING_TREES: Record<string, LandingReasoningTree> = {
  saas: {
    id: 'saas',
