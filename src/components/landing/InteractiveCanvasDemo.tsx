...
import { SAMPLE_REASONING_TREES } from './landingData';
import type { LandingReasoningNode } from './landingTypes';
import {
  ZoomIn,
  ZoomOut,
  RotateCcw,
...
export const InteractiveCanvasDemo: React.FC = () => {
  ...
  const handleAddNode = (e: React.FormEvent) => {
    ...
    const newNode: LandingReasoningNode = {
      id: newId,
      title: newNodeTitle,
          ...
          >
            ...
            >
              ...
              <svg className="absolute inset-0 h-full w-full pointer-events-none stroke-[#d4d4d4]" strokeWidth="2">
                ...
                {(Object.values(tree.nodes) as LandingReasoningNode[])
              ...
              <form onSubmit={handleAddNode} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewNodeCategory(e.target.value as LandingReasoningNode['category'])}
