...
export const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-14 bg-white/30 backdrop-blur-xl backdrop-saturate-150 border-b border-[#E5E2DD] px-4 md:px-6 flex items-center justify-between z-30 select-none">
